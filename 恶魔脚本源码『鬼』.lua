...
local Window = OrionLib:MakeWindow({Name = "恶魔中心", HidePremium = false, SaveConfig = true,IntroText = "恶魔脚本", ConfigFolder = "恶魔脚本"})
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "恶魔脚本"; Text ="恶魔脚本"; Duration = 4; })
